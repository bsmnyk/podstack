    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Sign in to save your favorite newsletters and sync across devices.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 mt-4">
          ...
          {/* <Button 
            className="w-full flex items-center justify-center gap-3 py-6 bg-[#1877F2] hover:bg-[#166FE5]"
          ...
          <Button 
            className="w-full flex items-center justify-center gap-3 py-6 bg-black hover:bg-gray-900"
